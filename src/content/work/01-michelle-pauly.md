...
beforeAfter:
  before:
    image: "before-home"
    caption: "The old site ran a built office straight into a graduate project, with nothing between them but a small centered label reading Graduate Work."
  after:
    image: "hero"
...
solution: |
  ...
  Every project, category and image is a document she edits in Sanity. She got the hang of it immediately and had her most recent work in and published on her own.
solutionGallery:
  - image: "category"
    caption: "The Commercial filter applied to the same grid."
  - image: "project"
    caption: "A project page, with the role block beside the lead image."
---
